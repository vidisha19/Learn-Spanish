...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("mustard yellow", "Amarilla mostaza",R.drawable.color_mustard_yellow,R.raw.mustard));
        words.add(new Word("dusty yellow", "Amarilla polvorienta",R.drawable.color_dusty_yellow,R.raw.dusty));
        ...
        words.add(new Word("white", "blanca",R.drawable.color_white,R.raw.white));
